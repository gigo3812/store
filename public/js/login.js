...
var app = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createApp)({
  ...
  computed: {},
  methods: {
    resendPinCode: function resendPinCode() {
      this.resendTime = 120;
      localStorage.setItem('resendTime', 120);
      var ls = this;
      intervalResendTime = setInterval(function () {
        if (ls.resendTime > 0) {
          ls.resendTime--;
        } else {
    ...
    // filter pin code
    filterNonNumeric: function filterNonNumeric() {
      this.pincode = this.pincode.replace(/\D/g, '');
    },
    // validate checker
    inValidate: function inValidate(type) {
    ...
    /**---------------------------------------------Start product read ---------------------------------------------*/checkMobileUniq: function checkMobileUniq(type) {
      var _this = this;
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return _context.abrupt("return", _this.$notify({
                type: 'error',
                text: "\u062F\u0631\u062E\u0648\u0627\u0633\u062A \u0628\u06CC\u0634 \u0627\u0632 \u062D\u062F. <br> \u0644\u0637\u0641\u0627 \u062A\u0627 ".concat(_this.resendTime, " \u062B\u0627\u0646\u06CC\u0647 \u062F\u06CC\u06AF\u0631 \u0634\u06A9\u06CC\u0628\u0627 \u0628\u0627\u0634\u06CC\u062F"),
                duration: 7000
              }));
            case 4:
              if (!_this.inValidate()) {
            ...
            case 6:
              ...
              _context.next = 10;
              return axios__WEBPACK_IMPORTED_MODULE_2___default().post('/user-auth', data, {
                headers: {
            ...
            case 10:
              ...
              return _context.abrupt("return", _this.sendConfirmCode());
            case 13:
              _this.$notify({
                type: 'warn',
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            ...
            case 5:
              ...
              _this4.$notify({
                type: 'success',
                text: "\u06A9\u062F \u062A\u0627\u0626\u06CC\u062F \u0628\u0647 \u0634\u0645\u0627\u0631\u0647 ".concat(_this4.mobile, " \u0627\u0631\u0633\u0627\u0644 \u0634\u062F"),
                duration: 7000
              });
              _this4.stepRegister = 1;
              _context4.next = 13;
              break;
            case 10:
              _context4.prev = 10;
    ...
    submitForget: function submitForget() {
      var _this5 = this;
