                    ...
                    <div class="panel panel-bordered">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="mobile" class="form-control" id="mobile" name="mobile" placeholder="موبایل" value="{{ old('mobile', $dataTypeContent->mobile ?? '') }}">
                            </div>
                            ...
                            {{-- role --}}
                            <div class="form-group">
                                <label for="default_role">نقش پیشفرض</label>
                                <select class="form-control" name="role_id" aria-hidden="true">
                                    <option value="3" <?php if ($dataTypeContent->role_id == 3) {
                                        echo 'selected';
                                    } ?> data-select2-id="3">مدیر سایت</option>
                                    <option value="2" <?php if ($dataTypeContent->role_id == 2) {
                                        echo 'selected';
                                    } ?> data-select2-id="2">کاربر عادی</option>
                                </select>
                            </div>
