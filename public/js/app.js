...
/* harmony export */   useNotification: () => (/* binding */ rt)
/* harmony export */ });
...
}, j = (0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  name: "velocity-group",
...
const z = /* @__PURE__ */ v(j, [["render", G]]), F = (0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  name: "css-group",
  inheritAttrs: !1,
  props: {
...
/* harmony import */ var vue_countup_v3__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! vue-countup-v3 */ "./node_modules/vue-countup-v3/dist/vue-countup-v3.es.js");
/* harmony import */ var v_viewer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! v-viewer */ "./node_modules/v-viewer/dist/index.es.js");
...
var app = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createApp)({
  ...
  components: {
    ...
    CountUp: vue_countup_v3__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  computed: {
    /** product page set detail product [min-order max-order and etc] in read.bleade product*/loadProduct: function loadProduct() {
      this.product.min_order = product ? product.min_order : 1;
      this.product.max_order = product ? product.max_order : 5;
    },
    activeMenu: function activeMenu() {
      var url = window.location.href;
      if (url.search('contact-us') > 0) return 'contact-us';else if (url.search('products') > 0) return 'products';
      return 'index';
    },
    /** cart page */loadCarts: function loadCarts() {
      this.carts = carts;
    },
    amount: function amount() {
      ...
      var cartCount = 0;
      if (this.carts) {
        this.carts.products.map(function (product) {
          price += product.stock;
          cartCount++;
        });
      }
  ...
  methods: {
    /**format numbers */numberWithCommas: function numberWithCommas(x) {
      if (!x) return 0;
      var parts = x.toString().split(".");
      parts[0] = parts[0].replace(/\B(?=(\d{3})+(?!\d))/g, ",");
      return parts.join(".");
    },
    sliderCount: function sliderCount() {
      var width = window.innerWidth;
      if (width > 1000) return 3.5;else if (width > 700) return 2.5;else return 1;
    },
    /**---------------------------------------------Start product read ---------------------------------------------*/addToCart: function addToCart(idProduct) {
      var _this = this;
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              data = {
                id: idProduct,
                count: _this.product.count
              };
              _context.next = 7;
              return axios__WEBPACK_IMPORTED_MODULE_5___default().post('/cart/add', data, {
                headers: {
            ...
            case 7:
              req = _context.sent;
              _this.cartCount = req.data.count;
              localStorage.setItem('cartCount', _this.cartCount);
              _this.product.max_order = _this.product.max_order - req.data.currentProduct;
              _this.product.count = 1;
              _this.$notify({
                type: 'success',
                text: "\u0639\u0645\u0644\u06CC\u0627\u062A \u0628\u0627 \u0645\u0648\u0641\u0642\u06CC\u062A \u0627\u0646\u062C\u0627\u0645 \u0634\u062F  <br> \n           \u062A\u0639\u062F\u0627\u062F ".concat(req.data.currentProduct, "  \u0639\u062F\u062F \u0627\u0632 \u0627\u06CC\u0646 \u0645\u062D\u0635\u0648\u0644 \u062F\u0631 \u0633\u0628\u062F \u062E\u0631\u06CC\u062F \u0634\u0645\u0627 \u0645\u0648\u062C\u0648\u062F \u0627\u0633\u062A . <br>\n           <a style='color:white' href='/cart/index'> \u062A\u06A9\u0645\u06CC\u0644 \u0648 \u067E\u0631\u062F\u0627\u062E\u062A </a>"),
                duration: 7000
              });
              _context.next = 18;
              break;
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 5:
              ...
              _context2.next = 9;
              return axios__WEBPACK_IMPORTED_MODULE_5___default().post('/cart/check-stock', data, {
                headers: {
                  'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                }
              });
            ...
            case 14:
              ...
              location.href = "/payment-request?&id=".concat(_this2.carts.id);
              _this2.cartCount = 0;
              localStorage.setItem('cartCount', _this2.cartCount);
              _context2.next = 25;
              break;
            case 21:
              _context2.prev = 21;
    ...
    copyToClipboard: function copyToClipboard(mytext) {
      var _this3 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return navigator.clipboard.writeText(mytext);
            case 3:
              _this3.$notify({
                type: 'success',
                text: "\u0645\u062A\u0646 ".concat(mytext, " \u06A9\u067E\u06CC \u0634\u062F")
              });
              _context3.next = 9;
              break;
            case 6:
  ...
  mounted: function mounted() {
    // // set cart count
    if (localStorage.getItem('cartCount')) this.cartCount = localStorage.getItem('cartCount');
  }
});
app.use(v_viewer__WEBPACK_IMPORTED_MODULE_3__["default"]);
app.use(_kyvg_vue3_notification__WEBPACK_IMPORTED_MODULE_4__["default"]);
app.use(aos__WEBPACK_IMPORTED_MODULE_6___default().init());
app.mount('#app');

/***/ }),

/***/ "./resources/scss/front/cart.scss":
/*!****************************************!*\
  !*** ./resources/scss/front/cart.scss ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/scss/front/login.scss":
/*!*****************************************!*\
  !*** ./resources/scss/front/login.scss ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/scss/front/layout.scss":
/*!******************************************!*\
  !*** ./resources/scss/front/layout.scss ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/scss/front/browse.scss":
/*!******************************************!*\
  !*** ./resources/scss/front/browse.scss ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/scss/front/read.scss":
/*!****************************************!*\
  !*** ./resources/scss/front/read.scss ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Viewer: () => (/* reexport default from dynamic */ viewerjs__WEBPACK_IMPORTED_MODULE_0___default.a),
...
const api = ({ images = [], options }) => {
  ...
  const ViewerToken = (0,vue__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    style: {
      display: "none"
    },
    class: ["__viewer-token"]
  }, images.map((attr) => {
    return (0,vue__WEBPACK_IMPORTED_MODULE_1__.h)("img", typeof attr === "string" ? { src: attr } : attr);
  }));
  (0,vue__WEBPACK_IMPORTED_MODULE_1__.render)(ViewerToken, token);
  const tokenElement = token.firstElementChild;
  document.body.appendChild(tokenElement);
  const $viewerJs = new (viewerjs__WEBPACK_IMPORTED_MODULE_0___default())(tokenElement, options);
  const $destroy = $viewerJs.destroy.bind($viewerJs);
  $viewerJs.destroy = function() {
    $destroy();
    (0,vue__WEBPACK_IMPORTED_MODULE_1__.render)(null, token);
    return $viewerJs;
  };
  $viewerJs.show();
...
const directive = ({ name = "viewer", debug = false } = {}) => {
  ...
  function createWatcher(el, binding, vnode, debouncedCreateViewer) {
    el.__viewerUnwatch = (0,vue__WEBPACK_IMPORTED_MODULE_1__.watch)(() => binding.value, (newVal, oldVal) => {
...
const _sfc_main = (0,vue__WEBPACK_IMPORTED_MODULE_1__.defineComponent)({
  ...
  setup(props, { emit }) {
    let $viewer;
    const root2 = (0,vue__WEBPACK_IMPORTED_MODULE_1__.ref)();
    function createViewer() {
      $viewer = new (viewerjs__WEBPACK_IMPORTED_MODULE_0___default())(root2.value, props.options);
      emit("inited", $viewer);
    }
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_1__.watch)(() => props.images, () => (0,vue__WEBPACK_IMPORTED_MODULE_1__.nextTick)(() => changeViewer()), options);
    (0,vue__WEBPACK_IMPORTED_MODULE_1__.watch)(() => props.trigger, () => (0,vue__WEBPACK_IMPORTED_MODULE_1__.nextTick)(() => changeViewer()), options);
    (0,vue__WEBPACK_IMPORTED_MODULE_1__.watch)(() => props.options, () => (0,vue__WEBPACK_IMPORTED_MODULE_1__.nextTick)(() => rebuildViewer()), options);
    (0,vue__WEBPACK_IMPORTED_MODULE_1__.onMounted)(() => createViewer());
    (0,vue__WEBPACK_IMPORTED_MODULE_1__.onUnmounted)(() => destroyViewer());
    return {
      root: root2,
      createViewer,
      rebuildViewer,
...
function useRaf(cb, delaySeconds = 1) {
  const rafId = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)(-1);
  let startTime;
...
const _sfc_main = /* @__PURE__ */ (0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)(__spreadProps(__spreadValues({}, __default__), {
  ...
  setup(__props, { expose, emit: emits }) {
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.watch)([() => props.startVal, () => props.endVal], () => {
      if (props.autoplay) {
        restart();
      }
    });
...
/******/ 	__webpack_require__.O(undefined, ["css/front/layout","css/front/read","css/front/browse","css/front/index","css/front/login","css/front/cart"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/front/layout","css/front/read","css/front/browse","css/front/index","css/front/login","css/front/cart"], () => (__webpack_require__("./resources/scss/front/layout.scss")))
/******/ 	__webpack_require__.O(undefined, ["css/front/layout","css/front/read","css/front/browse","css/front/index","css/front/login","css/front/cart"], () => (__webpack_require__("./resources/scss/front/index.scss")))
/******/ 	__webpack_require__.O(undefined, ["css/front/layout","css/front/read","css/front/browse","css/front/index","css/front/login","css/front/cart"], () => (__webpack_require__("./resources/scss/front/browse.scss")))
/******/ 	__webpack_require__.O(undefined, ["css/front/layout","css/front/read","css/front/browse","css/front/index","css/front/login","css/front/cart"], () => (__webpack_require__("./resources/scss/front/read.scss")))
/******/ 	__webpack_require__.O(undefined, ["css/front/layout","css/front/read","css/front/browse","css/front/index","css/front/login","css/front/cart"], () => (__webpack_require__("./resources/scss/front/cart.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/front/layout","css/front/read","css/front/browse","css/front/index","css/front/login","css/front/cart"], () => (__webpack_require__("./resources/scss/front/login.scss")))
